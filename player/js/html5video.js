...
_this.getDom.webkitRequestFullScreen();
     	...
     	//IOS
       _this.getDom.style.cssText="position:absolute; top: 0px; width:100%; height: 100%; z-index: 99; background-color:rgba(0,0,0,0.9); overflow: hidden;margin:0px; padding: 0px;padding-top:60%;";
       if(mui.os.plus)
		{
